...
export type RefineStyle = 'Automatic' | 'Casual' | 'Professional' | 'Academic' | 'Storytelling'; // This enum might need further refinement based on how 'Creative Intent' integrates.
